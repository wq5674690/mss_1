...
from app.app01.city_dict import *
from app.app01 import *
# import city_dict
# from app.app01.yaml import *
...
class GFWeather:
    ...
    def get_init_data(self):
        ...
        :return: None
        '''
        with open('app/app01/_config.yaml', 'r', encoding='utf-8') as f:
        ...
        print(f"girlfriend_infos的信息为：{girlfriend_infos}")
    ...
    def run(self):
        ...
        # 每天9：30左右给女朋友发送每日一句，函数misfire_grace_time是容错机制，设定指定时间范围继续执行，单位为秒
        ...
        if resp.status_code == 200 and self.isJson(resp) and resp.json().get('status') == 200:
            ...
            if start_date:
                try:
                    ...
                    delta_msg = f'宝贝老婆这是我们在一起的第 {day_delta} 天。\n'
                except:
                    delta_msg = ''
            else:
                delta_msg = ''
