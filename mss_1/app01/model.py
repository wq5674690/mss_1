...
class Apollo(db.Model):  # 继承SQLAlchemy.Model对象，一个对象代表了一张表
    ...
    def __repr__(self):  # 输出方法，与__str__类似，但是能够重现它所代表的对象
        ...
        # return '< %r, %r, %r, %r, %r, %r, %r, %r, %r, %r, %r>' % (self.ap_id, self.ap_date_time, self.ap_env, self.ap_db_name, self.ap_w_url, self.ap_w_user, self.ap_w_passwd, self.ap_r_url, self.ap_r_user, self.ap_r_passwd, self.ap_str_date)